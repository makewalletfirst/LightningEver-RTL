...
export class ECLForwardingHistoryComponent implements OnInit, OnChanges, AfterViewInit, OnDestroy {
  ...
  onForwardingEventClick(selFEvent: PaymentRelayed, event: any) {
    const reorderedFHEvent: MessageDataField[][] = [
      ...
      { key: 'fee', value: ((selFEvent.amountIn || 0) - (selFEvent.amountOut || 0)), title: 'Fee Earned (ever)', width: 50, type: DataTypeEnum.NUMBER }],
      [{ key: 'amountIn', value: selFEvent.amountIn, title: 'Amount In (ever)', width: 50, type: DataTypeEnum.NUMBER },
      { key: 'amountOut', value: selFEvent.amountOut, title: 'Amount Out (ever)', width: 50, type: DataTypeEnum.NUMBER }],
