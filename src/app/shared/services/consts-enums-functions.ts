...
// LightningEver: BTC→BEC, Sats→ever. Enum values are also used by the
// convertCurrency() switch so SATS/BTC keys must match the format-map keys.
export const CURRENCY_UNITS = ['ever', 'BEC'];
export const CURRENCY_UNIT_FORMATS = { ever: '1.0-0', BEC: '1.6-6', OTHER: '1.2-2' };
...
export enum CurrencyUnitEnum {
  SATS = 'ever', // LightningEver: was 'Sats'
  BTC = 'BEC',   // LightningEver: was 'BTC'
